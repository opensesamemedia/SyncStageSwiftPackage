...
let package = Package(
    ...
    dependencies: [],
    targets: [
        .binaryTarget(name: "SyncStageSDK", url: "https://public.sync-stage.com/sdk/ios/0.6.1/SyncStageSDK_0.6.1.xcframework.zip", checksum: "cc800e96cbf935fd5df0445ab36d100201d4a19b21c47e18c21dd3458756234c"),
