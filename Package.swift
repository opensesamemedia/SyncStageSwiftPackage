...
let package = Package(
    ...
    dependencies: [],
    targets: [
        .binaryTarget(name: "SyncStageSDK", url: "https://syncstage.s3.amazonaws.com/sdk/ios/SyncStageSDK_0.4.0.xcframework.zip", checksum: "955c20cb3350f432a6a5a3752b88b020599ba966eccca1cd2bec775c274b9832"),
